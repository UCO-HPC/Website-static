 ...
 * const authority2 = getAuthority( 'https://uco-hpc.github.io/Website-static:8080/test/' ); // 'localhost:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'https://uco-hpc.github.io/Website-static:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'https://uco-hpc.github.io/Website-static:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'https://uco-hpc.github.io/Website-static:8080/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'https://uco-hpc.github.io/Website-static:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
